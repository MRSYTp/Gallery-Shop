...
<header class="header-v4">
    ...
    <div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
        <div class="container-search-header">
            ...
            <form class="wrap-search-header flex-w p-l-15" action="{{route('frontend.index')}}">
                ...
                <li class="header-cart-item flex-w flex-t m-b-12">
                    <form action="{{route('frontend.basket.remove', $id)}}" method="post">
                        ...
                        <button type="submit" class="header-cart-item-img">
                            <img src="/storage/{{$value['demo_url']}}" alt="IMG">
                        </button>
                    </form>

                    <div class="header-cart-item-txt p-t-8">
                        <a href="{{route('frontend.product.show', $id)}}" class="header-cart-item-name m-b-18 hov-cl1 trans-04">
                            {{$value['title']}}
                        </a>
